...
const Dashboard_akun = () => {
  ...
  <Dashboard/>
  <main className="flex-1 pl-7 pr-7 ml-60 mt-8">
    ...
    <section className="grid grid-cols-4 gap-4">
      <div className="p-5 relative [background:linear-gradient(113deg,rgba(255,255,255,0.13)_3.51%,rgba(255,255,255,0.00)_111.71%)] shadow-[10.253px_12.303px_20.506px_0px_rgba(0,0,0,0.05)] backdrop-blur-[7.176966667175293px] rounded-[15px] border-[1.23px] border-solid border-[rgba(255,255,255,0.50)]">
        <button className="absolute top-0 right-0 text-white w-8 h-8 flex items-center justify-center focus:outline-none rounded-bl-3xl rounded-tr-xl [background:var(--Font,linear-gradient(180deg,#8A00D4_0%,#8F19BD_100%))] p-[15px]">⁝</button>
  ...
  <div className="text-left flex-1">
    ...
    <button className="mt-2 [background:linear-gradient(90deg,#4E2DD1_-82.02%,#8C3FD9_50.56%)] shadow-[0px_1px_3px_1px_rgba(0,0,0,0.15),0px_1px_2px_0px_rgba(0,0,0,0.30)] rounded-lg text-white py-1 px-2 text-sm hover:[background:var(--gradient2,linear-gradient(90deg,#4E2DD1_0%,#8C3FD9_93.45%))]">Saving Now</button>
  </div>
    ...
    <section className="mt-4 grid grid-cols-2 gap-4">
      ...
      <div className="p-4 [background:linear-gradient(113deg,rgba(255,255,255,0.13)_3.51%,rgba(255,255,255,0.00)_111.71%)] shadow-[10.253px_12.303px_20.506px_0px_rgba(0,0,0,0.05)] backdrop-blur-[7.176966667175293px] rounded-[15px] border-[1.23px] border-solid border-[rgba(255,255,255,0.50)]">
        <div className="flex items-center mb-4">
          <h3 className="text-lg font-semibold mr-1">History Transaction</h3>
          <button className="ml-60 flex justify-center text-white items-center gap-2.5 border border-[color:var(--BG,#ECEFF5)] px-2.5 py-1 rounded-[20px] border-solid  hover:bg-white hover:text-black">See More</button>
        </div>
        <ul>
