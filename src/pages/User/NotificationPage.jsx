import NotifItem from "@/components/All/NotifItem";
        ...
        <div className="w-full p-4 md:p-0">
          <div>
            ...
            <div className="flex flex-col justify-center items-center space-y-3">
              <p className="text-white text-center text-base md:text-lg font-medium font-['Roboto'] leading-normal tracking-tight px-0">
                We may still send you important notifications about <br /> your account outside of your notification settings
              </p>
