        ...
        <div className="mt-[50px] flex flex-col justify-center items-center space-y-20">
          <div className="flex flex-col justify-center items-center">
            ...
            <p className="text-center text-gray-100 text-xl font-normal font-['Roboto']">
              FinTrax was founded on November 19, 2016, with a mission to revolutionize the way people manage their finances. Our team of experienced financial professionals recognized the need for a more intuitive and user-friendly
              financial management platform, and we set out to create a solution that would simplify the complexities of financial planning and tracking.
            </p>
          </div>
          ...
          <div className="flex flex-col text-justify justify-center items-start space-y-[32px] max-w-[950px]">
            ...
            <ol className="text-gray-100 text-lg font-normal font-['Roboto'] list-decimal list-outside">
              <li className="pl-2">Transparency: We believe that financial management should be transparent and easy to understand. That's why we provide clear, concise information about our services and solutions.</li>
          ...
          <div className="flex flex-col text-justify justify-center items-start space-y-[32px] max-w-[950px]">
            ...
            <p className="text-gray-100 text-lg font-normal font-['Roboto']">
              Join our community today and discover a more streamlined, user-friendly approach to financial management. At FinTrax, we’re passionate about empowering individuals and businesses to take control of their financial futures.
            </p>
          </div>
        </div>
      </main>
