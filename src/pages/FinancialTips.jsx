...
import { TipsDatas } from "../data/TipsDatas";
    ...
    <>
      ...
      <main className="mx-[100px]">
        <div className="flex flex-col justify-center items-center mt-[200px] space-y-[100px]">
          ...
          <div className="w-full grid grid-cols-2 gap-[37px] place-items-center">
            {TipsDatas.map((data, i) => {
              return <TipsCard key={i} title={data.title} img={data.img} desc={data.desc} />;
            })}
          </div>
        </div>
      </main>
