          ...
          <div className="w-full md:w-[1040px] space-y-[20px] md:space-y-[60px]">
            ...
            <div className="flex flex-col text-justify justify-center items-start space-y-[32px] max-w-[950px]">
              ...
              <p className="text-gray-100 text-lg font-normal font-['Roboto']">
                ...
                <ul className="ml-5 mt-2 list-disc list-inside">
                  ...
                  <li>
                    To communicate with you, either directly or through one of our partners, including for customer service, to provide you with updates and other information relating to the website, and for marketing and promotional
                    purposes
                  </li>
            ...
            <div className="flex flex-col text-justify justify-center items-start space-y-[32px] max-w-[950px]">
              ...
              <p className="text-gray-100 text-lg font-normal font-['Roboto']">
                ...
                <ul className="ml-5 mt-2 mb-2 list-disc list-inside">
                  <li>
                    With Service Providers: We may share your information with third-party service providers to perform services on our behalf, such as payment processing, data analysis, email delivery, hosting services, customer service,
                    and marketing assistance.
                  </li>
                  <li>
                    For Business Transfers: We may share or transfer your information in connection with, or during negotiations of, any merger, sale of company assets, financing, or acquisition of all or a portion of our business to
                    another company.
                  </li>
            ...
            <div className="flex flex-col text-justify justify-center items-start space-y-[32px] max-w-[950px]">
              ...
              <p className="text-gray-100 text-lg font-normal font-['Roboto']">
                We may update our Privacy Policy from time to time. We will notify you of any changes by posting the new Privacy Policy on this page. You are advised to review this Privacy Policy periodically for any changes. Changes to
            ...
            <div className="flex flex-col text-justify justify-center items-start space-y-[32px] max-w-[950px]">
              ...
              <p className="text-gray-100 text-lg font-normal font-['Roboto']">
                ...
                <ul className="ml-5 mt-2 mb-2 list-disc list-inside">
                  <li>By email: privacy@fintrax.com </li>
                  <li>By visiting this page on our website: www.fintrax.com/contact </li>
