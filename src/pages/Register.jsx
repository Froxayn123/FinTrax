  ...
  return (
    ...
    <div className="max-w-4xl w-full p-8 bg-blue-500 bg-opacity-20 shadow-xl rounded-3xl flex items-center">
      <div className="flex-1 pr-8 top-0">
        <h2 className="text-2xl text-white font-bold mb-16 mr-1">New to our website?
      ...
      <h3 className="text-3xl text-white font-bold mb-4 text-center">Register</h3>         
        <div className="p-5">
            ...
            <button 
            className="text-white w-full px-4 py-2 rounded-lg pl-10 mb-4 transition-colors duration-300" style={{ background: 'linear-gradient(to right, #4E2DD1 50%, #8C3FD9 100%)' }}
            onClick={handleRegister}>Register</button>

            <p className="text-white mt-0 text-center">Or already have an account?{" "} <Link to="/Login" className="text-[#CD37FF] hover:underline">
            Login
            </Link></p>
          </div>
