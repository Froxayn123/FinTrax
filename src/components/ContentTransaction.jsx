...
const transactions = [
  { name: "Food & beverages", date: "2024-05-10", amount: +15000000, category: "Payment", icon: "/F&B.png", description: "Mie Gacoan" },
  { name: "education", date: "2024-05-11", amount: -500000, category: "Payment", icon: "/Education.png", description: "Skilvul Course" },
  { name: "Transportation", date: "2024-05-12", amount: -2000000, category: "Receive", icon: "/Transportation.png", description: "Vehiclel Maintenance" },
];

const handleAddTransaction = () => {
  // Logic untuk menambahkan transaksi baru
