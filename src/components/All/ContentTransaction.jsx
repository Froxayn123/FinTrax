...
const ContentTransaction = () => {
  ...
  const handleExport = () => {
    const csvContent = `data:text/csv;charset=utf-8,${[
      ...
      ...transactions.map((transaction) => [transaction.name, transaction.date, transaction.amount, transaction.category, transaction.description]),
    ]
      .map((e) => e.join(","))
      .join("\n")}`;
  ...
  return (
    <div className="bg-white bg-opacity-10 border-2 border-white border-opacity-25 p-4 ml-4 lg:ml-12 mt-4 lg:mt-4 mr-4 lg:mr-12 rounded-xl">
      <div className="mb-4 flex flex-col lg:flex-row items-start lg:items-center">
        ...
        <div className="flex flex-wrap items-center lg:items-start lg:ml-4">
          <div className="flex space-x-2">
            <input
              ...
              className="text-white border bg-transparent border-gray-300 max-w-36 p-1 pl-4 mb-2 lg:mb-0 placeholder-white rounded-full"
            />
            <input
              type="text"
        ...
        <div className="flex flex-wrap items-center lg:ml-auto mt-2 lg:mt-0 space-x-2">
          <button
            onClick={handleAddTransaction}
            className="text-white font-medium py-1 px-4 rounded-lg flex items-center hover:bg-blue-400"
      ...
      <div className="mb-2 flex flex-col lg:flex-row items-start lg:items-center">
        <div className="flex space-x-2 mb-2 lg:mb-0 lg:ml-4">
        ...
        <div className="relative lg:ml-auto w-full lg:w-auto">
          <input
            ...
            className="text-white border bg-transparent border-gray-300 p-1 pl-10 rounded-xl w-full search-icon placeholder-white"
          />
