  ...
  return (
    <section id="general" className="mb-6 mt-4 mr-5 ml-5">
      <div className="border-b-2 pb-2 border-[#797979]">
        <h1 className="text-4xl text-white font-semibold mb-2">General</h1>
        <h3 className="text-xl text-white">Update your business persona</h3>
      </div>
      <div className="mt-6">
        <div className="flex space-x-10 mt-6">
          ...
          <div className="flex-1">
            <label className="block text-white text-xl mb-2">Name</label>
            <input type="text" id="country" placeholder="FINTRAX" className="w-full py-[8px] px-[16px] text-white text-lg border bg-transparent placeholder-white border-white rounded-md" />
          </div>
          <div className="flex-1">
            <label className="block text-white text-xl mb-2">Email</label>
            <input type="email" id="email" placeholder="fintaxsupport@gmail.ac.id" className="w-full py-[8px] px-[16px] text-white text-lg border bg-transparent placeholder-white border-white rounded-md" />
          </div>
        </div>
        <div className="flex space-x-10 mt-6">
          <div className="flex-1">
          ...
          <div className="flex-1">
            ...
            <input type="text" id="citu" placeholder="Jakarta" className="w-full py-[8px] px-[16px] text-white text-lg border bg-transparent placeholder-white border-white rounded-md" />
          </div>
          <div className="flex-1">
            <label className="block text-white text-xl mb-2">Fax</label>
            <input type="text" id="fax" placeholder="- - -" className="w-full py-[8px] px-[16px] text-white text-lg border bg-transparent placeholder-white border-white rounded-md" />
          </div>
        </div>
        <div className="flex space-x-10 mt-6">
          <div className="flex-1">
          ...
          <div className="flex-1">
            ...
            <input type="text" id="street" placeholder="Sudirman" className="w-full py-[8px] px-[16px] text-white text-lg border bg-transparent placeholder-white border-white rounded-md" />
          </div>
          <div className="flex-1">
            <label className="block text-white text-xl mb-2">Phone Number</label>
            <input type="tel" id="phonenumber" placeholder="+62 88765432109" className="w-full py-[8px] px-[16px] text-white text-lg border bg-transparent placeholder-white border-white rounded-md" />
          </div>
        </div>
      </div>
