...
const FeaturesSection = ({ onClickFeature }) => {
    ...
    <>
      <section id="feature-section" className="grid grid-cols-2 md:grid-cols-3 gap-[54px] place-content-start place-items-start pt-[96px]">
        ...
        {features.map((feature) => (
          <FeatureCard key={feature.id} img={feature.img} title={feature.title} desc={feature.desc} onClick={!onClickFeature ? () => handleCardClick(feature) : () => onClickFeature()} />
        ))}
      </section>
