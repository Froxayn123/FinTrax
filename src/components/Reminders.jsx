    ...
    const renderFooter = () => {
      return (
        <div className="flex justify-between mt-4">
          <button className="bg-gray-500 text-white px-4 py-1 rounded">Cancel</button>
          <button className="bg-purple-500 text-white px-4 py-1 rounded" onClick={handleAddReminder}>
            New
          </button>
        </div>
      );
